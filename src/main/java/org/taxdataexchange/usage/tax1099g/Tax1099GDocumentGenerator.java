...
import irs.fdxtax641.jsonserializers.Tax1099GSerializer;
import irs.fdxtax641.map2objects.Map2Tax1099G;
import org.taxdataexchange.core.pdfbuilders.Tax1099GPdfBuilder;
...
public class Tax1099GDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099G obj = Map2Tax1099G.generate( row );
        {
            String asJson = Tax1099GSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099G.csv";
        ...
        String outputFileName = "Tax1099G.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099GDocumentGenerator generator = new Tax1099GDocumentGenerator( );
