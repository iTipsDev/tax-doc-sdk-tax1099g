package org.taxdataexchange.usage.tax1099g;

import org.taxdataexchange.core.utils.*;
import org.taxdataexchange.docs.tax1099g.models.*;
import org.taxdataexchange.docs.tax1099g.utils.*;

public class Tax1099GDocumentGenerator {
    ...
    public static TaxDataList sampleData( ) {
        ...
        // Sample data
        // -----------------------------------------------------------------
        TaxData taxData = SampleData.sampleTaxData( "Tax1099G" );
    ...
    public static byte[] sampleQrAsPng( ) {
        ...
        Tax1099GPdfBuilder pdfBuilder = new Tax1099GPdfBuilder( );
        byte[] bytes = pdfBuilder.buildQr( taxDataList );

        String filePath = "samples/Tax1099G.qr.png";
    ...
    public static void samplePdf( ) {
        ...
        String filePath = "samples/Tax1099G.sample.pdf";
        FileUtils.bytesToFile( pdfBytes, filePath );
        System.out.println( filePath );

        String filePathPng = "samples/Tax1099G.sample.png";
    ...
    public static void addCoverPage() {
        ...
        String filePath2 = "samples/Tax1099G.cover.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void insertQrCode() {
        ...
        String filePath2 = "samples/Tax1099G.inserted.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void main(String[] args) {
        ...
        System.out.println( "Tax1099GDocumentGenerator Begin" );
        ...
        System.out.println( "Tax1099GDocumentGenerator Done" );
