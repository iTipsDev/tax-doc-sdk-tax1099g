# tax-doc-sdk-tax1099g

Software development kit to generate IRS Form 1099-G as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099G.sample.png" width="850"/>
